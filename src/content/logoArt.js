...
export const LOGO_ART = {
  markDark: `<defs>
        ...
        <filter id="__ID__shadow" x="-100" y="-100" width="500" height="520" filterUnits="userSpaceOnUse"><feGaussianBlur in="SourceAlpha" stdDeviation="15" result="b"/><feOffset in="b" dy="15" result="o"/><feFlood flood-color="#000" flood-opacity=".26" result="c"/><feComposite in="c" in2="o" operator="in"/></filter>
        ...
        <use href="#__ID__star" stroke="#000" stroke-width="29" opacity=".26"/><use href="#__ID__star" stroke="url(#__ID__rim)" stroke-width="24" opacity=".60"/><use href="#__ID__star" stroke="url(#__ID__body)" stroke-width="19" opacity=".55" filter="url(#__ID__morph)"/><use href="#__ID__star" stroke="#fff" stroke-width="2.2" opacity=".82"/>
        <use href="#__ID__hook" stroke="#fff" stroke-width="88" opacity=".18" filter="url(#__ID__glow)"/><use href="#__ID__hook" stroke="url(#__ID__rim)" stroke-width="83" opacity=".58"/><use href="#__ID__hook" stroke="#090b0a" stroke-width="77" opacity=".14"/><use href="#__ID__hook" stroke="url(#__ID__body)" stroke-width="71" opacity=".40" filter="url(#__ID__morph)"><animate attributeName="opacity" values=".32;.50;.38;.32" dur="6.2s" repeatCount="indefinite"/></use><use href="#__ID__hook" stroke="url(#__ID__core)" stroke-width="49" opacity=".20"/><use href="#__ID__hook" stroke="#fff" stroke-width="11" opacity=".22"/><use href="#__ID__hook" stroke="#fff" stroke-width="2.6" opacity=".97"/>
  ...
  markLight: `<defs>
      ...
      <g transform="translate(45 45) scale(1.27)">
        <use href="#__ID__star" stroke="#303532" stroke-width="29" opacity=".30"/><use href="#__ID__star" stroke="#747c78" stroke-width="24" opacity=".37"/><use href="#__ID__star" stroke="url(#__ID__body)" stroke-width="19" opacity=".55" filter="url(#__ID__morph)"/><use href="#__ID__star" stroke="#fff" stroke-width="2"/>
        <use href="#__ID__hook" stroke="#252a28" stroke-width="92" opacity=".11" filter="url(#__ID__shadow)"/><use href="#__ID__hook" stroke="#fff" stroke-width="84" opacity=".28" filter="url(#__ID__glow)"/><use href="#__ID__hook" stroke="#6e7672" stroke-width="80" opacity=".13"/><use href="#__ID__hook" stroke="url(#__ID__body)" stroke-width="72" opacity=".44" filter="url(#__ID__morph)"><animate attributeName="opacity" values=".36;.54;.42;.36" dur="6.2s" repeatCount="indefinite"/></use><use href="#__ID__hook" stroke="url(#__ID__core)" stroke-width="48" opacity=".22"/><use href="#__ID__hook" stroke="#59615d" stroke-width="2.2" opacity=".44"/>
  ...
  lockupDark: `<defs>
        ...
        <filter id="__ID__shadow" x="-120" y="-120" width="1120" height="650" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
          ...
          <feFlood flood-color="#000" flood-opacity=".26" result="color"/><feComposite in="color" in2="offset" operator="in"/>
        </filter>
      ...
      <g transform="translate(60 40)">
        <use href="#__ID__star" stroke="#000" stroke-width="29" opacity=".26"/><use href="#__ID__star" stroke="url(#__ID__rim)" stroke-width="24" opacity=".60"/><use href="#__ID__star" stroke="url(#__ID__body)" stroke-width="19" opacity=".55" filter="url(#__ID__morph)"/><use href="#__ID__star" stroke="#fff" stroke-width="2.2" opacity=".82"/>
        <use href="#__ID__word" stroke="#000" stroke-width="94" opacity=".38" filter="url(#__ID__shadow)"/><use href="#__ID__word" stroke="#fff" stroke-width="88" opacity=".17" filter="url(#__ID__glow)"/>
        <use href="#__ID__word" stroke="url(#__ID__rim)" stroke-width="83" opacity=".58"/><use href="#__ID__word" stroke="#090b0a" stroke-width="77" opacity=".14"/>
        <use href="#__ID__word" stroke="url(#__ID__body)" stroke-width="71" opacity=".40" filter="url(#__ID__morph)"><animate attributeName="opacity" values=".32;.50;.38;.32" dur="6.8s" repeatCount="indefinite"/></use>
        <use href="#__ID__word" stroke="url(#__ID__core)" stroke-width="49" opacity=".20"/><use href="#__ID__word" stroke="#fff" stroke-width="11" opacity=".22"/><use href="#__ID__word" stroke="#fff" stroke-width="2.6" opacity=".97"/>
        ...
        <ellipse cx="526" cy="178" rx="14.5" ry="9.5" transform="rotate(-8 526 178)" fill="#050505" opacity=".30"/><ellipse cx="526" cy="178" rx="14.5" ry="9.5" transform="rotate(-8 526 178)" fill="none" stroke="#eef1ef" stroke-opacity=".66" stroke-width="2.6"/>
      </g>
      <g transform="translate(372 385)"><use href="#__ID__descriptor" stroke="#000" stroke-width="10" opacity=".34"/><use href="#__ID__descriptor" stroke="url(#__ID__rim)" stroke-width="7"/><use href="#__ID__descriptor" stroke="url(#__ID__body)" stroke-width="4.8"/><use href="#__ID__descriptor" stroke="#fff" stroke-width="1.2" opacity=".82"/></g>`,
  lockupLight: `<defs>
      ...
      <g transform="translate(60 40)">
        <use href="#__ID__star" stroke="#303532" stroke-width="29" opacity=".30"/><use href="#__ID__star" stroke="#747c78" stroke-width="24" opacity=".37"/><use href="#__ID__star" stroke="url(#__ID__body)" stroke-width="19" opacity=".55" filter="url(#__ID__morph)"/><use href="#__ID__star" stroke="#fff" stroke-width="2"/>
        <use href="#__ID__word" stroke="#252a28" stroke-width="92" opacity=".11" filter="url(#__ID__shadow)"/><use href="#__ID__word" stroke="#fff" stroke-width="84" opacity=".28" filter="url(#__ID__glow)"/><use href="#__ID__word" stroke="#6f7773" stroke-width="80" opacity=".13"/><use href="#__ID__word" stroke="url(#__ID__body)" stroke-width="72" opacity=".44" filter="url(#__ID__morph)"><animate attributeName="opacity" values=".36;.54;.42;.36" dur="6.8s" repeatCount="indefinite"/></use><use href="#__ID__word" stroke="url(#__ID__core)" stroke-width="48" opacity=".22"/><use href="#__ID__word" stroke="#5d6561" stroke-width="2.2" opacity=".44"/>
        ...
        <ellipse cx="526" cy="178" rx="14.5" ry="9.5" transform="rotate(-8 526 178)" fill="#fff" opacity=".34"/><ellipse cx="526" cy="178" rx="14.5" ry="9.5" transform="rotate(-8 526 178)" fill="none" stroke="#737b77" stroke-opacity=".55" stroke-width="2.4"/>
      </g>
      <g transform="translate(372 385)"><use href="#__ID__descriptor" stroke="#fff" stroke-width="9" opacity=".30"/><use href="#__ID__descriptor" stroke="#646b68" stroke-width="6.2" opacity=".52"/><use href="#__ID__descriptor" stroke="url(#__ID__body)" stroke-width="4.8"/><use href="#__ID__descriptor" stroke="#252a28" stroke-width="1" opacity=".58"/></g>`,
};
