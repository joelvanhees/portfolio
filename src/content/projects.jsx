...
export const buildProjects = ({ setActiveImage }) => [
  ...
  },
  {
    ...
    visualComponent: <LazyImage src={checkYourBusImg} className="w-full h-full object-cover hover:scale-105 transition-transform duration-700 cursor-zoom-in" alt="Check Your Bus Preview" onClick={() => setActiveImage(checkYourBusImg)} />,
  ...
  },
  {
    ...
    visualComponent: <LazyImage src={previewWebImg} className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" alt="Web Design Preview" />,
    link: "#",
    featured: true,
    hasPdf: true,
    pdfUrl: pdfFile,
...
The P50 becomes a platform rather than a product.`,
    ...
    visualComponent: <LazyImage src={carImg} className="w-full h-full object-cover cursor-zoom-in" alt="Car Preview" onClick={() => setActiveImage(carImg)} />,
    link: "#",
    featured: true,
  },
  {
    ...
    visualComponent: <LazyImage src={posterImg} className="w-full h-full object-cover cursor-zoom-in" alt="Poster Preview" onClick={() => setActiveImage(posterImg)} />,
    link: "#",
    featured: true,
  },
  {
    ...
    visualComponent: <LazyImage src={nasalicaImg} className="w-full h-full object-cover hover:scale-110 transition-transform duration-700 cursor-zoom-in" alt="Nasalica Preview" onClick={() => setActiveImage(nasalicaImg)} />,
    link: "#",
    featured: true,
    exhibitions: [
...
Designed from scratch through sixteen full revisions (the build shown here is V16), each one resolving the same conflict: enough interior volume for the animatronics, thin enough walls to keep the object readable as a planet rather than a housing. Digitally sculpted, sectioned and pressure-tested in CAD, then 3D printed, assembled and finished by hand.`,
  ...
  },
  {
    ...
    visualComponent: <LazyImage src={brandingImg} className="w-full h-full object-cover cursor-zoom-in" alt="Branding Preview" onClick={() => setActiveImage(brandingImg)} />,
    link: "#",
    featured: true,
  },
];
